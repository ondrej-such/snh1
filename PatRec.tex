...
\affiliation[1]{organization={Matematický ústav Slovenskej Akadémie Vied},
...
\affiliation[2]{organization = {Žilinská Univerzita v Žiline},
...
\begin{highlights}
\item New Bayes covariant coupling methods
\item New way to create ensembles of multiple Bayes covariant methods
\item Unification of Hastie-Tibshirani and Wu-Lin-Weng method
\item Rigorous evaluation of coupling methods
\end{highlights}
