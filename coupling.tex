...
A cycle is a path with length $s\geq 3$ such  all vertices $C_{i_1}, \ldots, C_{i_s}$ are distinct and the starting and the ending vertices coincide i.e. $i_1 = i_{s+1}$. A tree is a graph without a cycle.
