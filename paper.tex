...
There is a plethora of methods available for coupling. Let us describe four major classes.
...
\begin{equation}
	\hat {\boldsymbol{p}} = \bigoplus_{i=1}^K p_i \hat{\boldsymbol{T}}_i. \label{eq:radial}
\end{equation}
%
...
- are there Bayes covariant methods that match the performance of Wu-Lin-Weng's method ?
- when priors change, is it better to apply Bayes update before or after coupling?
- which coupling methods are best with respect to Hinton's minimality?
