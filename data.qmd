...
sink("data-tbl.tex")
print(xtable(df_sep_sum, label = "tab:sep-sum", digits = 2,
    caption = "Average number of binary subproblems that are separable for a given dataset"), include.rownames = FALSE)
sink()
```
